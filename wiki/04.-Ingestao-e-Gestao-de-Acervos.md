...
- **Inserção Direta na Timeline por Duplo Clique:** Dê um duplo clique rápido em qualquer card de vídeo ou foto para enviá-lo instantaneamente à timeline na posição da agulha (com proteção de debounce no player Source).
