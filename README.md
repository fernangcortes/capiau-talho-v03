...
* **👥 Biometria Facial e Desambiguação em Massa:** Tela dedicada para catalogação de elenco e equipe técnica, permitindo reatribuir, fundir grupos de rostos idênticos e rejeitar artefatos com preview de vídeo de contexto em hover.
