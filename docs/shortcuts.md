...
| **`Shift + F`** *(ou `Alt+F` no Final Cut)* | **Localizar Quadro na Timeline (Reverse Match Frame)** | Do Source Player, localiza onde o quadro atual foi utilizado na timeline ativa, salta a agulha para o corte e seleciona o clipe (com desempate por proximidade). |
...
| **`Shift + F`** *(ou `Alt+F` no Final Cut)* | **Localizar na Timeline (Reverse Match Frame)** | Do Source Player, localiza onde o quadro atual foi utilizado na timeline ativa, salta a agulha e seleciona o clipe. |
